/*global chrome*/
import { SF_API_VERSION } from "@/components/store/globalConstants";
export let apiVersion = localStorage.getItem("apiVersion") == null ? SF_API_VERSION : localStorage.getItem("apiVersion");
